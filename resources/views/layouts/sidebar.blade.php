...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10">
        ...
        <x-nav-link class="flex items-center px-6 py-2 mt-4 w-full" :href="route('admincategory')" :active="request()->routeIs('admincategory')">
            ...
            <span class="mx-3">{{ __('Categories') }}</span>
        </x-nav-link>


        <x-nav-link class="flex items-center px-6 py-2 mt-4 w-full" :href="route('adminbrand')" :active="request()->routeIs('adminbrand')">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z" />
            </svg>
            <span class="mx-3">{{ __('Brands') }}</span>
        </x-nav-link>


        <x-nav-link class="flex items-center px-6 py-2 mt-4 w-full" :href="route('adminimagelibrary')" :active="request()->routeIs('adminimagelibrary')">
            <x-svgicons.image-gallery-svg-icon size='6' color='currentColor' />
            <span class="mx-3">{{ __('Image Library') }}</span>
        </x-nav-link>


        <x-nav-link class="flex items-center px-6 py-2 mt-4 w-full" :href="route('adminproduct')" :active="request()->routeIs('adminproduct')">
            <x-svgicons.product-svg-icon size='6' color='currentColor' />
