@props(['name', 'show' => false, 'maxWidth' => '2xl', 'position' => ''])
...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto {{ $name }} {{ $position }}"
