    ...
    <div class="max-w-7xl mx-auto">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    @foreach ($variants as $variant)
                                        <tr wire:key="{{ $variant->id }}" class="border-b dark:border-gray-700">
                                            <th scope="row"
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $variant->name }}</th>

                                            <td class="px-4 py-3">{{ $variant->created_at }}</td>
        ...
        <div>
            @include('components.delete-confirm-modal', [
                'name' => 'confirm-variant-deletion',
                'errorDeletion' => 'variantDeletion',
                'destroyMethod' => 'destroyVariant',
                'closeEvent' => 'close-delete-variant-modal',
                'confirmationMessage' => 'Are you sure you want to delete your variant?',
