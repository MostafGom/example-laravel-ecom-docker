<x-modal wire:ignore.self name="edit-variant-modal" :show="$errors->variantAddition->isNotEmpty()" focusable>

    <form wire:submit.prevent="updateVariant" class="p-6" x-on:close-edit-variant-modal.window="show=false">
        @csrf
