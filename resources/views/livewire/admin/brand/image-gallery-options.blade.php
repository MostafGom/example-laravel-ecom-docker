<div class="mt-24 bg-gray-300">
    <div class="bg-white dark:bg-gray-300 shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-800 leading-tight">
                {{ __('Choose Brand Image ( You can only assign one image )') }}
            </h2>
    ...
    @endif
    <div x-data="{ selectedImage: {{ $brand->image_id ?? 0 }} || 0 }" x-init="console.log(selectedImage);
    $watch('selectedImage', (val) => {
        console.log(val);
        $wire.brand.image_id = selectedImage;
    })" class="pt-16">
