                                    ...
                                    @foreach ($products as $product)
                                        <tr wire:key="{{ $product->id }}" class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3 flex items-center justify-between gap-1">
                                                ...
                                                {{-- <x-secondary-button wire:click="editProduct({{ $product->id }})"
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', { name: 'update-product-modal',productId:{{ $product->id }}});">
                                                        <x-svgicons.edit-svg-icon size='5' />
                                                ...
                                                <x-danger-button wire:click="deleteProduct('{{ $product['id'] }}')"
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', { name: 'confirm-product-deletion'})"
